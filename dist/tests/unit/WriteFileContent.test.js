...
describe('test WriteFile class', function () {
    ...
    context("test that we're still not able to write to file", () => {
        ...
        it('test that we cannot write files because fs.existsSync is false and are getting error message', function () {
    ...
    context("test that we're able to write to file", () => {
        ...
        it('test that we can write files because fs.existsSync is true and are not getting error message', function () {
            return __awaiter(this, void 0, void 0, function* () {
                let cb = (e, r) => __awaiter(this, void 0, void 0, function* () {
